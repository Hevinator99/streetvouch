...
const unresolved="f.status!='resolved' AND (f.status IN ('new','attention','escalated') OR f.severity!='normal' OR f.due_at IS NOT NULL OR (f.contact_requested=1 AND f.contacted_at IS NULL))";
