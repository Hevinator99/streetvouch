...
export async function POST(request:Request){
  ...
  try{
    ...
    return json({ok:true,message:analysis.model==="streetvouch-rules-v1"?"Safety analysis completed. Add the OpenAI key to enable richer AI analysis.":"AI analysis completed."});
